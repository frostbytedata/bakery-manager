...
export class InitialMigration1666290055304 implements MigrationInterface {
    name = 'InitialMigration1666290055304'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "unit" ("id" SERIAL NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying NOT NULL, "type" "public"."unit_type_enum" NOT NULL DEFAULT 'volume', "abbr" character varying NOT NULL, CONSTRAINT "PK_4252c4be609041e559f0c80f58a" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "conversion" ("id" SERIAL NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "rate" integer NOT NULL, "ingredientId" integer, CONSTRAINT "PK_47d350fae88ddb04db6de706bc8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "ingredient" ("id" SERIAL NOT NULL, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying NOT NULL, "defaultUnitId" integer, CONSTRAINT "REL_11a0f49f7c7b2153e122a30660" UNIQUE ("defaultUnitId"), CONSTRAINT "PK_6f1e945604a0b59f56a57570e98" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`INSERT INTO public.unit (name, description, abbr, type) VALUES ('Ounce', '', 'oz', 'weight')`,);
        await queryRunner.query(`INSERT INTO public.unit (name, description, abbr, type) VALUES ('Fluid Ounce', '', 'fl oz', 'weight')`,);
        await queryRunner.query(`INSERT INTO public.unit (name, description, abbr, type) VALUES ('Gram', '', 'g', 'weight')`,);
        await queryRunner.query(`INSERT INTO public.unit (name, description, abbr, type) VALUES ('Cup', '', 'cup', 'volume')`,);
        await queryRunner.query(`INSERT INTO public.unit (name, description, abbr, type) VALUES ('Tablespoon', '', 'tbsp', 'volume')`,);
        await queryRunner.query(`INSERT INTO public.unit (name, description, abbr, type) VALUES ('Teaspoon', '', 'tsp', 'volume')`,);
    }
