...
export class InitialMigration1668228588724 implements MigrationInterface {
    name = 'InitialMigration1668228588724'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "ingredient" ("id" SERIAL NOT NULL, "global" boolean NOT NULL DEFAULT false, "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" character varying NOT NULL, "description" character varying, "userId" integer, "defaultUnitId" integer, CONSTRAINT "REL_11a0f49f7c7b2153e122a30660" UNIQUE ("defaultUnitId"), CONSTRAINT "PK_6f1e945604a0b59f56a57570e98" PRIMARY KEY ("id"))`);
